...
%%
function [outfreq] = Particle_Swarm_Optimizationsc1(Bird_in_swarm, Number_of_quality_in_Bird, MinMaxRange, Food_availability, availability_type, velocity_clamping_factor, cognitive_constant, social_constant, Min_Inertia_weight, Max_Inertia_weight, max_iteration,hi,lamda,gamma,dh,sm)
...
for itr=1:max_iteration
    ...
    for p=1:Bird_in_swarm
        ...
        availability(p,itr)=fitnessfuncsc1(parameter,hi,lamda,gamma,dh,sm);
