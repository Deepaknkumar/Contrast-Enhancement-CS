...
lamda = 10;%variable to determine the amount of contrast
gamma = 50000;
...
hir = freqr;                %for R
[freqr] = abcsc1(15,hir,lamda,gamma,D,xr);
freqr = transpose(freqr);

hig = freqg;            %for G
[freqg] = abcsc1(15,hig,lamda,gamma,D,xg);
freqg = transpose(freqg);

hib = freqb;               %for B
[freqb] = abcsc1(15,hib,lamda,gamma,D,xb);
